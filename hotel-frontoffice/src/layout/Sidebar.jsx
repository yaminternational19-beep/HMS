    ...
    >
      ...
      <div className="mt-auto border-t border-white/10 p-3 flex flex-col gap-3 shrink-0">
        <div className="flex items-center gap-3">
          {/* Avatar with Praveen Reddy initials */}
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold truncate leading-tight">Praveen Reddy</p>
              <p className="text-[10px] text-white/50 truncate">Front Desk Manager</p>
            </div>
          )}
        </div>
